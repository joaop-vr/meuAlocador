...
alocaMem:
    ...
    # Loop para o worst-fit
    movq topoInicialHeap, %rax
    movq $0, %r12               # r12: guarda a quantidade de bytes do maior bloco da heap
    movq $0, %r13               # r13: guarda o endereço para o maior bloco livre

loopAloca:
    cmpq topoAtualHeap, %rax
    jge tomarDecisao            # tomarDecisao: verifica se iremos alocar no final da heap ou no worst-fit
...
comparaComOMaior:
    ...
    # Atualizamos o registrador com o maior size e o endereço desse bloco
    movq %rbx, %r12
    movq %rax, %r13
    jmp continuaOLoop
...
tomarDecisao:
    cmpq $0, %r12
    jne alocaWorstFit          # se r12 == 0 então nao existe worst-fit, logo o código segue linearmente ate a rotina "alocaBloco"
...
*************************************************/
reparteBloco:   # ATENÇÃO! ESTÁ FUNÇÃO NÃO ESTÁ SENDO UTILIZADA NESSA VERSÃO ALTERADA
